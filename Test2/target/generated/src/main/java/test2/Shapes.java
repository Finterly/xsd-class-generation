 ...
 *                           &lt;attribute name="rotation" type="{http://pathvisio.org/GPML/2021}RotationType" default="Top" /&gt;
 *                         &lt;/restriction&gt;
 *                       &lt;/complexContent&gt;
 *                     &lt;/complexType&gt;
 *                   &lt;/element&gt;
...
public class Shapes {
    ...
    protected List<Shapes.Shape> shape;
     ...
     * 
     */
    public List<Shapes.Shape> getShape() {
        if (shape == null) {
            shape = new ArrayList<Shapes.Shape>();
        }
        return this.shape;
    }
    ...
    public static class Shape {
        ...
        protected Shapes.Shape.Graphics graphics;
         ...
         * @return
         *     possible object is
         *     {@link Shapes.Shape.Graphics }
         *     
         */
        public Shapes.Shape.Graphics getGraphics() {
            return graphics;
        }
         ...
         *     
         */
        public void setGraphics(Shapes.Shape.Graphics value) {
            this.graphics = value;
        }
